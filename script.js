    ...
    const dataStore = {
        translations: {
            en: {
                ...
                hero_subtitle: "Join thousands of successful traders using our proven strategies and expert guidance.",
                ...
                footer_desc: "Your trusted partner in the world of trading. We provide education, tools, and support.",
                quick_links: "Quick Links",
                edu_resources: "Educational Resources",
                contact_us: "Contact Us",
                footer_copyright: "© 2024 SniperTrader. All rights reserved. Trading involves risk.",
            ...
            bn: {
                ...
                hero_subtitle: "আমাদের প্রমাণিত স্ট্র্যাটেজি এবং বিশেষজ্ঞ গাইডেন্স ব্যবহার করে হাজারো সফল ট্রেডারদের সাথে যোগ দিন।",
                ...
                footer_logo_text: "SniperTrader",
                footer_desc: "ট্রেডিং জগতে আপনার বিশ্বস্ত সঙ্গী। আমরা আপনাকে সফল হতে সাহায্য করার জন্য শিক্ষা, টুলস এবং সাপোর্ট প্রদান করি।",
                quick_links: "দ্রুত লিঙ্ক",
                edu_resources: "শিক্ষামূলক রিসোর্স",
                contact_us: "যোগাযোগ করুন",
                footer_copyright: "© 2024 SniperTrader. সর্বস্বত্ব সংরক্ষিত। ট্রেডিং ঝুঁকিপূর্ণ।",
